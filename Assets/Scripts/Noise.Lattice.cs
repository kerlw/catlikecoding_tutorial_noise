    ...
    public struct Lattice2D<G> : INoise where G : struct, IGradient {
        public float4 GetNoise4(float4x3 positions, SmallXXHash4 hash) {
            ...
            return lerp(
                ...
                lerp(
                    g.Evaluate(h0.Eat(z.p0), x.g1, z.g1),
                    g.Evaluate(h0.Eat(z.p1), x.g1, z.g1),
                    z.t
                ),
                x.t
            );
    ...
    public struct Lattice3D<G> : INoise where G : struct, IGradient {
        public float4 GetNoise4(float4x3 positions, SmallXXHash4 hash) {
            ...
            return lerp(
                lerp(
                    lerp(
                        g.Evaluate(h0.Eat(z.p0), x.g0, y.g0, z.g0),
                        g.Evaluate(h0.Eat(z.p1), x.g0, y.g0, z.g1),
                        z.t
                    ),
                    lerp(
                        g.Evaluate(h0.Eat(z.p0), x.g0, y.g1, z.g0),
                        g.Evaluate(h0.Eat(z.p1), x.g0, y.g1, z.g1),
                        z.t
                    ),
                    y.t
                ),
                lerp(
                    lerp(
                        g.Evaluate(h0.Eat(z.p0), x.g1, y.g0, z.g0),
                        g.Evaluate(h0.Eat(z.p1), x.g1, y.g0, z.g1),
                        z.t
                    ),
                    lerp(
                        g.Evaluate(h0.Eat(z.p0), x.g1, y.g1, z.g0),
                        g.Evaluate(h0.Eat(z.p1), x.g1, y.g1, z.g1),
                        z.t
                    ),
                    y.t
                ),
